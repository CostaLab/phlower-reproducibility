...
adata = pickle.load(open("save/phlower_k12_ndc5_s1_step2.pickle", 'rb'))
print(datetime.now(), "loaded.")

print(datetime.now(), "loading bdata...")
bdata = pickle.load(open('save/phlower_d12_18.pickle', 'rb'))
print(datetime.now(), "loaded.")
...
if True:
    ...
    pickle.dump({"indist":indist, "inind":inind, 'a2b_index':ddd, "r_a2b_index":rddd}, open("save/indist_inind_d12_d18.pickle", 'wb'))
else:
    d = pickle.load(open("save/indist_inind_d12_d18.pickle", 'rb'))
